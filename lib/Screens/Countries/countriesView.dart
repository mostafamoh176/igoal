...
class _CountriesViewState extends State<CountriesView> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CountriesViewModel>(
        init: CountriesViewModel(isTrue:widget.istrue),
        builder: (viewModel) {
          return SafeArea(
            top: false,
            bottom: false,
            child: Scaffold(
              ...
              body: Column(
                children: [
                  ...
                  Expanded(
                    child:(viewModel.searchCountriesList!=null)?Container(
                      ...
                      child: Directionality(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            print(viewModel.searchCountriesList.length);
  ...
  Widget interNationalItem(Countries country, CountriesViewModel countriesViewModel, int mainIndex) {
    return Padding(
      ...
      child: Column(
        children: [
          InkWell(
            ...
            onTap: (){
              countriesViewModel.onExpansionChanged(mainIndex);
            },
            child: Row(
              children: [
                Container(
                  height: 28,
                  width: 28,
                   child:(country.countryLogoPath!=null)? Image.network(country.countryLogoPath):Container(child: Image.asset("assets/images/goal.png",fit: BoxFit.cover,),),
                ),
                SizedBox(
                  width: 13,
                ),
          ...
          (country.isExpanded==true)?Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder:(BuildContext context,int index){
                   return countryItem(country.data[index].data,countriesViewModel, index,mainIndex);
                }),
          ):Container()
        ],
      ),
  ...
  Widget countryItem(dynamic league,CountriesViewModel viewModel,int index,int mainIndex) {
    return Container(
      height: 50,
      width: MediaQuery.of(context).size.width,
      ...
      child: InkWell(
        ...
        onTap: (){
         // print("Here");
          if(viewModel.isTrue==false){
            //viewModel.onFavouriteSave(league,index,mainIndex );
            if(viewModel.searchCountriesList[mainIndex].data[index].isFavorite==false) {
              showCustomDialog(
                  context, viewModel, league, index, mainIndex,
                  title: "هذا سوف يترك التطبيق", okBtnFunction: () {});
            }
            if(viewModel.searchCountriesList[mainIndex].data[index].isFavorite==true){
              showCustomDialogForDeleting(context, viewModel, league, index, mainIndex, title: "", okBtnFunction: (){});
        ...
        child: Row(
          children: [
            Container(
              ...
              child: (league["logo_path"]!=null)?Image.network(league['logo_path']):Container(),
            ),
            ...
            (viewModel.isTrue==false)? Spacer():Container(),
            (viewModel.isTrue==false)?InkWell(
                splashColor:Colors.transparent,
                hoverColor: Colors.transparent,
                focusColor: Colors.transparent,
                highlightColor:Colors.transparent,
                ...
                child: Icon(Icons.star,color:(viewModel.searchCountriesList[mainIndex].data[index].isFavorite==true)? Colors.red:Colors.black45,)):Container(),
  ...
  Widget searchTextField(CountriesViewModel viewModel) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: FormTextField(
  ...
  showCustomDialog(BuildContext context,CountriesViewModel viewModel,dynamic league,int index,int mainIndex,{@required String title, @required Function okBtnFunction}) {
    showDialog(
        context: context,
        builder: (_) {
            ...
            builder: (context, setState){
              return AlertDialog(
                ...
                title: Directionality(
                    ...
                    child: Text('اضافة',style: Theme.of(context).primaryTextTheme.headline1,)),
                content: Directionality(
                    textDirection: ui.TextDirection.ltr,
                    child: Text('هل تريد اضافة الفريق',style:Theme.of(context).primaryTextTheme.headline1,)),
                actions: <Widget>[
                  Directionality(
                    textDirection: ui.TextDirection.rtl,
                    child: Row(
                      children: [
                        InkWell(
                            ...
                            child: Text("نعم",style:Theme.of(context).primaryTextTheme.headline6,)),
                        SizedBox(width: 16,),
                        InkWell(
                            splashColor:Colors.transparent,
                            hoverColor: Colors.transparent,
                            ...
                            child: Text("لا",style:Theme.of(context).primaryTextTheme.headline6,)),
                      ],
                    ),
                  ),
  ...
  showCustomDialogForDeleting(BuildContext context,CountriesViewModel viewModel,dynamic league,int index,int mainIndex,{@required String title, @required Function okBtnFunction}) {
    showDialog(
        context: context,
        builder: (_) {
          return AlertDialog(
            ...
            title: Directionality(
                textDirection: ui.TextDirection.ltr,
                child: Text('حذف',style: Theme.of(context).primaryTextTheme.headline1,)),
            content: Directionality(
                textDirection: ui.TextDirection.ltr,
                child: Text('هل تريد حذف الفريق',style:Theme.of(context).primaryTextTheme.headline1,)),
            actions: <Widget>[
              Directionality(
                textDirection: ui.TextDirection.rtl,
                child: Row(
...
// //   Container(
// //     //color: Colors.white,
// //     height:(isExpandedCountry==false) ?55*1.0:(77+80)*1.toDouble(),
